...
If you don't want either installer:

```bash
git clone --depth=1 https://github.com/ananthanandanan/skills.git /tmp/_skills

# Project-scoped
mkdir -p .claude/skills && cp -r /tmp/_skills/skills/engineering/review-board .claude/skills/
